...
<body>
    ...
    <div class="flex w-full">
        <div class="relative w-1/2"> 
            ...
            <button class="absolute inset-0 flex items-center justify-center w-full h-full text-2xl font-bold text-white transition bg-black bg-opacity-50 hover:bg-opacity-75">Alquileres</button> 
        </div> 
        <div class="relative w-1/2"> 
            <img src="images/casa6.avif" alt="Venta" class="object-cover w-full h-full"> 
            <button class="absolute inset-0 flex items-center justify-center w-full h-full text-2xl font-bold text-white transition bg-black bg-opacity-50 hover:bg-opacity-75">Venta</button> 
        </div> 
    </div>
