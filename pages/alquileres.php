...
<head>
    ...
    <title>Alquileres - Next Home</title>
...
<body>
    ...
    <div class="self-center justify-center text-center mb-8">
        <h1 class="text-4xl font-bold text-center mb-6">Propiedades en Alquiler</h1>
    </div>
    ...
    <div class="m-8 p-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-auto ">
        <?php
            ...
            $seleccionarTodo = "SELECT * FROM propiedad WHERE contrato_propiedad = 'alquiler'";
